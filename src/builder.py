...
#     rename these to direction+zone, eg EA2
    formulas = {'3A1': {1: [building_max_x, building_max_y],
                ...
                '4E': {1: [building_max_x-5*Lb, building_origin_y+2*Lb],
                       ...
                       3: [building_origin_x+5*Lb, building_origin_y],
                       4: [building_origin_x+5*Lb, building_origin_y+2*Lb],
                       5: [building_origin_x+7*Lb, building_origin_y+2*Lb],
                       6: [building_origin_x+7*Lb, building_origin_y+3*Lb],
                       7: [building_max_x-7*Lb, building_origin_y+3*Lb],
                       8: [building_max_x-7*Lb, building_origin_y+2*Lb]},
                ...
                '1E': {1: [building_max_x-5*Lb, building_origin_y+2*Lb],
                       2: [building_max_x-5*Lb, building_origin_y],
                       3: [building_origin_x+5*Lb, building_origin_y],
                       4: [building_origin_x+5*Lb, building_origin_y+2*Lb],
                       5: [building_origin_x+7*Lb, building_origin_y+2*Lb],
